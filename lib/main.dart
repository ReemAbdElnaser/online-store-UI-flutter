...
import 'package:project_app/shopinng/shopping_model.dart';
import 'onbording/welcome.dart';
...
Future<void> main() async {
  ...
  // Set GetX test mode (if necessary)
  Get.testMode = true;

  // Run the app with ChangeNotifierProvider and GetX
  runApp(
   MultiProvider(
      providers: [
        // Provide ShoppingCartModel
